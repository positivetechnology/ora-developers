...
var Scroll = function () {
  ...
  _createClass(Scroll, [{
    ...
    value: function bindEvents() {
      ...
      $(document).on('mousewheel DOMMouseScroll wheel scroll resize', _underscore2.default.debounce(function () {
        var $sections = $('[data-section]');
        var viewport = {
          top: win.scrollTop(),
          left: win.scrollLeft()
        ...
        _this._public.activeIndex = index;
      }, 50, false));
      ...
      $(window).on('resize', _underscore2.default.debounce(function () {
        _this.loadImages(_this._public.activeIndex);
      }, 10));
    ...
    value: function loadImages(index) {
      ...
      $bgImages.map(function (i, image) {
        ...
        if ((typeof src === 'undefined' ? 'undefined' : _typeof(src)) === 'object') {
          var activeMq = _this2.getActiveMq(window.pjs.mqs, src);
