...
var Toggle = function () {
  ...
  _createClass(Toggle, [{
    key: 'bindEvents',
    value: function bindEvents() {
      var evName = !$('body').hasClass('touch') ? 'click' : 'mouseover mouseout';
      var $elem = $(this.sel.component);
      var $toggle = $elem.find(this.sel.toggle);
      $toggle.on(evName, function (e) {
        e.preventDefault();
