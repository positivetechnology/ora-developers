...
gulp.task('javascript', ['lint'], function(){
	...
	// Where all src js files are
	var scriptsPath = '../../public/javascript';
	// Script build dest > not to public folder yet
	var scriptDest = 'javascript/mini';

	var dirs = getDirs('./javascript');
...
gulp.task('build', ['sass', 'javascript'], function() {
	...
	gulp.src(['./javascript/*.js', '!./node_modules/**/*']).pipe(gulp.dest('../../public/javascript'));
